...
1. Create a new GitHub repositories and name it `Bootstrap-Portfolio`. - Done

2. Clone this repository to your computer. - Done

3. Inside your `Bootstrap-Portfolio` repo, create the folder structure for the webpage. - Done
   
   - Create a folder structure.

     - Create a `index.html`. - Done

     - Create a `css` folder. - Done

       - Inside create a `style.css` file. - Done

   - Create an `images` folder. - Done

       - Place all your images in this folder. - Done

4. Using Bootstrap, recreate your portfolio site with the following items:

   The website should include the following bootstrap components:

    - A Navigation bar - Done
    
    - A navigation menu at the top. Feel free to use bootstrap's navbar or create your own. - Done
